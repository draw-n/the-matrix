    ...
    try {
        if (
            ...
            let material = new Material({
                ...
                remotePrintEquipmentIds: JSON.parse(
                    remotePrintEquipmentIds || "[]",
                ),
                remotePrintConfigName: file ? file.filename : null,
                remotePrintAvailable,
            });
            await material.save();
